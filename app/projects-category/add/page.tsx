...
const AddProjectCategoryPage = () => {
  ...
  const [status, setStatus] = useState<'residential' | 'commercial' | 'landowner'>('residential');
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                <select
                  id="status"
                  value={status}
                  onChange={(e) => setStatus(e.target.value as 'residential' | 'commercial' | 'landowner')}
...
export default AddProjectCategoryPage;
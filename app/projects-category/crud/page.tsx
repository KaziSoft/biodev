...
export default function ProjectsCategoryCrudPage() {
  ...
  const handleDelete = async (id: string) => {
    ...
    setDeleting(id);
    try {
      const res = await fetch(`/api/project-category/${id}`, {
        method: 'DELETE',
      });
                      ...
                      <tr key={project._id} className="hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors duration-150">
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                          <div className="flex justify-end space-x-4">
                            <Link
                              href={`/projects-category/crud/edit?id=${project._id}`}

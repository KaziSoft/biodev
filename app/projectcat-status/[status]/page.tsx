...
export default function ProjectCatogoryStatusViewPage() {
  ...
  useEffect(() => {
    const fetchProjects = async () => {
      try {
        setLoading(true);
        const res = await fetch(`/api/projectcat-status?status=${status}`);
        ...
        <div className="relative z-10 pb-12 pt-24 sm:pt-32 lg:pb-16 lg:pt-40 px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="mt-10 flex justify-center space-x-4">
              <Link
                href="/projectcat-status/residential"
              ...
              <Link
                href="/projectcat-status/commercial"
                className={`inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md ${
                  status === 'commercial' 
                    ? 'bg-white text-[#7AA859]' 
                    : 'text-white border-white hover:bg-white/10'
              ...
              <Link
                href="/projectcat-status/landowner"
                className={`inline-flex items-center px-6 py-3 border border-transparent text-base font-medium rounded-md ${
                  status === 'landowner' 
                    ? 'bg-white text-[#7AA859]' 
                    : 'text-white border-white hover:bg-white/10'
                  ...
                  <div className="p-6">
                    ...
                    {(project.startDate || project.endDate) && (
                      <div className="flex items-center text-sm text-gray-500 mb-4">
                        ...
                        {project.endDate && project.status === 'commercial' && (
